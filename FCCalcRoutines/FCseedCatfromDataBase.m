    ...
    if exist([Date,'-',Mouse, '-fc-', outname, '.mat'])
        for r=1:numel(regtype)
            ...
            if ismember(['MeanfcMaps_',Mouse, '_', regtype{r}], {vars.name})&&ismember(['MeanR_LR_',Mouse, '_', regtype{r}], {vars.name})
                ...
                load([Date,'-',Mouse, '-fc-', outname, '.mat'])
                ...
                save([directory,Date,'-',Mouse, '-fc-', outname, '.mat'], ['fcMap_',Mouse,'_',regtype{r}],['R_',Mouse,'_',regtype{r}], '-append');
                ...
                save([directory,Date,'-',Mouse, '-fc-', outname, '.mat'], ['MeanfcMaps_',Mouse,'_',regtype{r}],['MeanR_LR_',Mouse,'_',regtype{r}],['MeanR_AP_',Mouse,'_',regtype{r}],'-append');
